...
class Vmd:
    ...
    #     valid_frame_number = 0
    #     for i in tqdm(range(bone_keyframe_number), desc='Processing'):
    #         if motion_data["BoneKeyFrameTransformRecord"][i]["BoneName"] not in Mmd_Skeleton.standard_bones:
    #             # print(motion_data["BoneKeyFrameRecord"][i]["BoneName"])
    #             continue
    #         # print(motion_data["BoneKeyFrameRecord"][i]["BoneName"])
    #         valid_frame_number += 1
    #         bone_name = motion_data["BoneKeyFrameTransformRecord"][i]["BoneName"].encode(model_name_encode,errors='ignore')
            
    #         keyframe_array_list.append(bone_name)
    #         keyframe_array_list = pad_zero_list(keyframe_array_list,15 - len(bone_name))
    #         keyframe_array_list.append(struct.pack("<Ifffffff",motion_data["BoneKeyFrameRecord"][i]["FrameTime"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Position"]["x"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Position"]["y"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Position"]["z"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Rotation"]["x"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Rotation"]["y"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Rotation"]["z"],
    #                                         motion_data["BoneKeyFrameTransformRecord"][i]["Rotation"]["w"]))
